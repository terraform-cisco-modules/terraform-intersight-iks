...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_terraform-intersight-iks"></a> [terraform-intersight-iks](#module\_terraform-intersight-iks) | terraform-cisco-modules/iks/intersight// | 2.0.4 |
...
| <a name="input_tags"></a> [tags](#input\_tags) | variable "vc\_password" { sensitive   = true type        = string description = "Password of the account to be used with vCenter.  This should be the password for the account used to register vCenter with Intersight." } | `list(map(string))` | `[]` | no |
